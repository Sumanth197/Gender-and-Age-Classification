...
base_dir = '/home/sumanth/Documents/cv_pro/gender_age_classification-master'
files_list = ['fold_0_data_temp.txt','fold_1_data_temp.txt']
...
make_age_data(age_data)
#make_age_gender_data(age_gender_data)
